...
| **`planner.py`** | Rule-based **workflow choice** (eksakte delstreng-triggere først; deretter **`list_employees`**-fallback; deretter **`create_customer`**-fallback med verb+entitet+navn; se **§5** punkt 20–21) og **light slot extraction** (`customer_name`, `name`, produkt-felt, **`invoice_autocreate_product`**, **`payment_invoice_number`** / **`payment_amount`** / **`payment_date`**, `email`, `phone`, `notes`, `target_entity`, **`workflow_route`** / **`workflow_route_detail`**, `hints`). `Plan` bruker **`Optional[float]`** (ikke `float \| None`) for Pydantic på **Python 3.9**. |
...
*Last updated: 2026-03-20 — **§5** punkt 21 `create_customer` ord-basert fallback; punkt 20 `list_employees` fallback + **`plan_built`**-routing; punkt 19 korte synonymer; **§20** deploy-runbook + Cloud Shell-feilsøking; **§19** NM endpoint; **§18** score mode; **§17** grønne workflows; **§16** faktura/payment miljø; **3.11** anbefalt.*
