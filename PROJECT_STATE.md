...
|----------|---------------------|----------------------|
| `list_employees` | `list employees`, `find employees`, `show employees`, `get employees`, `ansatte` | `GET /employee` |
...
*Last updated: 2026-03-20 — **§5** punkt 19 NM noop / `list_employees`-synonymer; **§20** deploy-runbook + Cloud Shell-feilsøking; **§19** NM endpoint; **§18** score mode; **§17** grønne workflows; **§16** faktura/payment miljø; **3.11** anbefalt.*
