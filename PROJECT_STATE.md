...
*Last updated: 2026-03-20 — **§5** punkt 20 `list_employees` fallback + **`plan_built`**-routing-logg; punkt 19 korte synonymer; **§20** deploy-runbook + Cloud Shell-feilsøking; **§19** NM endpoint; **§18** score mode; **§17** grønne workflows; **§16** faktura/payment miljø; **3.11** anbefalt.*
